  ...
  return (
    <div className="space-y-3 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Legend
                    wrapperStyle={{ ...legendStyle, fontSize: 10, color: CHART_PALETTE.axis }}
                  />
                </PieChart>
              </ResponsiveContainer>
            </div>
          ) : (
            <div className="h-48 flex justify-center items-center text-slate-400/50 border border-dashed border-slate-300/50 rounded-xl text-xs">
              No hay datos suficientes de gastos
            </div>
          )}
        </div>
        ...
        <div className="glass-card rounded-xl p-4">
          <h3 className="text-sm font-bold text-slate-800 tracking-tight mb-4">
            Composición de Ingresos (Fijos vs Variables)
          </h3>
          {isLoadingAnalytics ? (
            <div className="h-48 flex justify-center items-center">
              <Activity className="w-5 h-5 animate-spin text-slate-400" />
            ...
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={income} margin={chartMargins.default}>
                  <CartesianGrid
                    strokeDasharray="3 3"
                    vertical={false}
            ...
            <div className="h-48 flex justify-center items-center text-slate-400/50 border border-dashed border-slate-300/50 rounded-xl text-xs">
              No hay datos suficientes de ingresos
            </div>
          )}
        </div>
      </div>
